export default function TermsOfService() {
  return (
    <div className="max-w-3xl mx-auto pt-6 bg-[rgba(255,255,255,0.75)] shadow-md">
      ...
      <div className="flex flex-col gap-6 pb-6 px-6">
        ...
        <section>
          ...
          <ol className="list-decimal list-inside text-gray-800">
            ...
            <li>
              "질문"이란 회원이 서비스 내에서 생성하고 공유하는 콘텐츠를
              말합니다.
            </li>
            <li>
              "답변"이란 회원이 다른 회원의 질문에 대해 작성한 콘텐츠를
              말합니다.
            </li>
          </ol>
        </section>
        <section>
          ...
          <ol className="list-decimal list-inside text-gray-800">
            ...
            <li>
              부꾸러미는 필요한 경우 관련 법령을 위배하지 않는 범위에서 본
              약관을 변경할 수 있습니다. 약관이 변경될 경우 부꾸러미는
              변경사항을 시행일 15일 전부터 공지하며, 회원에게 불리한 변경의
              경우 30일 전부터 공지합니다.
            </li>
          </ol>
        </section>
        <section>
          ...
          <ol className="list-decimal list-inside text-gray-800">
            ...
            <li>
              부꾸러미는 서비스의 내용, 품질, 또는 기술적 사양 등의 변경이
              필요한 경우 변경 사항을 사전에 공지합니다.
            </li>
          </ol>
        </section>
        <section>
          ...
          <ol className="list-decimal list-inside text-gray-800">
            <li>
              ...
              <ul className="list-disc list-inside ml-6">
                ...
                <li>
                  부꾸러미가 제공하는 서비스에 정보를 허위로 기재하는 행위
                </li>
        ...
        <section>
          ...
          <p className="text-gray-800">
            회원의 게시물이 관련 법령 및 본 약관에 위반되는 내용을 포함하는
            경우, 부꾸러미는 해당 게시물을 삭제 또는 게시 중단할 수 있습니다.
          </p>
        </section>
        <section>
          <h2 className="text-xl font-semibold mb-3">
          ...
          <p className="text-gray-800">
            부꾸러미는 회원이 본 약관의 의무를 위반하거나 서비스의 정상적인
        ...
        <section>
          ...
          <ol className="list-decimal list-inside text-gray-800">
            ...
            <li>
              부꾸러미는 회원의 귀책사유로 인한 서비스 이용의 장애에 대하여
              책임을 지지 않습니다.
            </li>
          </ol>
        </section>
        <section>
          ...
          <p className="text-gray-800">
            본 약관의 해석 및 부꾸러미와 회원 간의 분쟁에 대하여는 대한민국의
            법을 적용합니다.
          </p>
        </section>
      </div>
